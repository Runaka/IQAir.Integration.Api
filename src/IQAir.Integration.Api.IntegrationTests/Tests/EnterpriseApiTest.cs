...
public sealed class EnterpriseApiTest
{
    ...
    [Test]
    public async Task GetGlobalCityRankingTest()
    {
        var responses = await _iqairApiService!.GetGlobalCityRankingV2(new GetGlobalCityRankingRequest()
        {
            Country = "India",
            Sort = "desc"
        });
